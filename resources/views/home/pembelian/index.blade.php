...
<div class="card border-0 shadow rounded">
    <div class="card-body">
        ...
        @endif
        <h4 class="text-center fw-bolder">Pembelian Proyek</h4>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('delpembelian', $item->invoice) }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-sm mt-1 mt-xl-0 btn-danger">Batal Beli</button>
                        </form>
                    </td>
                </tr>
                @empty
